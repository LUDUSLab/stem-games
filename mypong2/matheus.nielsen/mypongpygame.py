...
pygame.display.set_caption("MyPong - PyGame Edition - Matheus Nielsen - Versão 0.0")
...
# victory text
victory_font = pygame.font.Font('D:/Meus Documentos/Documentos/GitHub/stem-games/mypong2/assets/PressStart2P.ttf', 100)
